...
This project is a continuation on the task before the last, which was about classes.
...
class ToyotaCamry07:
    ...
    model_name = "Camry"
    make_year = 2007
    def __init__(self, vin, color, owner, fuel=100.0, engine_mods=[], destination=None):
        # instance attributes
        self.__vin = vin
        self.color = color
        self._owner = owner
